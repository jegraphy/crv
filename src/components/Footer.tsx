...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-gray-900/80 backdrop-blur-sm border-t border-gray-800 flex flex-col items-center space-y-4 py-6 text-sm text-secondary z-50 open-sans-light">
